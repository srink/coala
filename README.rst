...
* The ``bears`` key specifies which bears (plugins) you want to use. We support
  ...
  `bears that work for all languages <https://github.com/coala-analyzer/bear-docs/blob/master/README.rst#all>`__. Or you can file an issue and we would build a bear for you!
